...
(function () {
  ...
  css.textContent = [
    ...
    '.jrv-btn{font:700 11px/1 "Cormorant Garamond",Georgia,serif;letter-spacing:.06em;text-transform:uppercase;padding:8px 12px;border-radius:7px;border:1px solid #2A241D;background:transparent;color:#E5E2DD;cursor:pointer;transition:border-color .2s ease,color .2s ease,background .2s ease}',
    ...
    '.jrv-bar button{font:700 11px/1 "Cormorant Garamond",Georgia,serif;letter-spacing:.06em;text-transform:uppercase;padding:11px 14px;border-radius:10px;border:1px solid #2A241D;background:rgba(21,18,15,.92);color:#E5E2DD;cursor:pointer;-webkit-backdrop-filter:blur(8px);backdrop-filter:blur(8px);box-shadow:0 8px 26px rgba(0,0,0,.45);transition:border-color .2s ease,color .2s ease,background .2s ease}',
